...
const drawerPopupRoundedClasses: Record<DrawerPosition, string> = {
...
const drawerPopupBeforeRoundedClasses: Record<DrawerPosition, string> = {
...
const drawerPopupNestedTransformClasses: Record<DrawerPosition, string> = {
  bottom:
...
const getDrawerPopupClassName = (
  position: DrawerPosition,
  variant: "default" | "straight" | "inset",
  className?: string
): string =>
  cn(
    drawerPopupBaseClassName,
    drawerPopupPositionClasses[position],
    variant !== "straight" && drawerPopupRoundedClasses[position],
    variant === "default" && drawerPopupBeforeRoundedClasses[position],
    variant === "inset" &&
    ...
    drawerPopupNestedTransformClasses[position],
    className
  );
    ...
    <DrawerPortal {...portalProps}>
      ...
      <DrawerViewport position={position} variant={variant}>
        <DrawerPrimitive.Popup
          className={getDrawerPopupClassName(position, variant, className)}
